...
// const BuildArtifactCheckPlugin = require('../plugins/build-check-plugin');
...
async function startWorker() {
  ...
  // scanner.use(new CountCheckPlugin());
  // scanner.use(new FileCheckPlugin());
  // scanner.use(new PackageCheckPlugin());
  // scanner.use(new DependencyCheckPlugin());
  // scanner.use(new BuildArtifactCheckPlugin());
  scanner.use(new StylelintCheckPlugin());
